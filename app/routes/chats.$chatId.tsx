...
const messages = [...data.chat.messages]
    ...
    return (
        <div
            className='flex flex-col h-screen items- border-2 w-full overflow-auto mb-10'
        >
            <h1>Chat</h1>
            ...
            >
                <input type='text' name='content' className='text-black rounded-xl border-2 w-full' />
                <Button
