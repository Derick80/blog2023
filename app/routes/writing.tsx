...
export async function loader({ request, params }: LoaderFunctionArgs) {
    ...
    const postsData = postData.filter((post) => post !== null && post.published === true)
...
export default function WritingRoute() {
    ...
    return (
        <div
            className= 'flex flex-col items-center justify-around w-full h-full p-2 gap-4'
        >
            <h1>Writing</h1>
            <Outlet />
            <div
                ...
                { postData.map((post) =>
                    ...
                    (
                        <div
                            ...
                            <p>{ post.author }</p>
                            <ul
                                className='flex gap-2 flex-row flex-wrap w-full '
