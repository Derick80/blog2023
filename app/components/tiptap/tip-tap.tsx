...
import { INTENTS } from '../blog-ui/post/blog-edit-card';
...
const TipTap = ({ content, postId, setContent }: {
  ...
  return (
    <div className='flex flex-col gap-2 rounded-md bg-background shadow-[0_2px_10px] shadow-foreground'>
