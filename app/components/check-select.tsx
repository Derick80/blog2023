...
export const CheckSelect = ({ options, picked, postId }: Props) => {
    ...
    return (
        <div
            className='relative flex flex-col items-start justify-start h-full p-2 overflow-y-auto bg-background text-foreground rounded-md shadow-sm'>
                        ...
                        <Button
                            ...
                            onClick={ () => {
                                setSelected((prevSelected) =>
                                    prevSelected.filter((item) => item.id !== item.id)
                                )
                            }
                            }
                            variant='secondary'
            ...
            >
                ...
                >
                    ...
                    { options.map((option, index) => (
                        <div key={ option.id } className='flex flex-row items-center justify-start w-full h-8'
                        ...
                        >
                            ...
                            />
                            <label htmlFor={ option.label } className='ml-2 text-sm font-medium text-gray-700'>
                                { option.label }
                            </label>
                        </div>
                    )) }
