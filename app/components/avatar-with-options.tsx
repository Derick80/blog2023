        ...
        <HoverCard>
            <HoverCardTrigger asChild>
                <Button variant='outline' size='icon'>
                    <Avatar>
                        { avatarUrl && username ? (<AvatarImage src={ avatarUrl } alt={ username } />
                        ) : null }
                        <AvatarFallback>
                            <UserPlaceHolder />
                        </AvatarFallback>
            ...
            <HoverCardContent>
                ...
                { !user ? (
                    ...
                    <NavLink
                        ...
                        to='/login'
                        className={ ({ isActive }) => `m-0 flex items-center justify-center p-1 ${isActive ? 'bg-gray-100 dark:bg-gray-800' : ''}` }
                    >
                        <P
                            text='Login'
                        >
