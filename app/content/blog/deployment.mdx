...
3. Setup Fly. It might ask if you want to deploy, say no since you havent built the app yet.
...
If youve followed the setup instructions already, all you need to do is run this:
