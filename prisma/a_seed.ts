    ...
    for (let i = 0; i < projects.length; i++) {
        await prisma.project.create({
            data: {
                ...
                technologyStacks: {
                    connectOrCreate: projects[i].technologyStacks.map(
                        (tech) => {
                            return {
...
const mdxPostsToSeed = [
    ...
    },
    {
        ...
        datePublished: '2023-11-06',
        published: true,
        categories: ['databases', 'planning', 'documentation'],
        slug: 'database'
    },
    {
        title: 'Deployment',
    ...
    },
    {
        ...
        datePublished: '2023-11-15',
        published: true,
        categories: ['Fall-2023-Planning', 'planning', 'documentation'],
